...
describe('List', () => {
  ...
  describe('break', () => {
    describe('(gt(3), [1,2,3,4,5])', () => {
      it('== [[],[1,2,3,4,5]]', () => {
        List.break_(gt(3), [1,2,3,4,5]).should.be.eql([[], [1,2,3,4,5]]);
      });
    });
    describe('(gt(3))([1,2,3,4,5])', () => {
      it('== [[],[1,2,3,4,5]]', () => {
    ...
    describe('(gt(3), [5,4,3,2,1,2,3,4,5])', () => {
      it('== [[5,4,3],[2,1,2,3,4,5]]', () => {
        List.break_(gt(3), [5,4,3,2,1,2,3,4,5]).should.be.eql([[5,4,3], [2,1,2,3,4,5]]);
      });
    });
    describe('(gt(3), [5,4,3,4,5])', () => {
      it('== [[5,4,3,4,5],[]]', () => {
        List.break_(gt(3), [5,4,3,4,5]).should.be.eql([[5,4,3,4,5], []]);
      });
    });
  });
